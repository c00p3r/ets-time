...
module.exports = {
  validators: {
    ...
    project_activity_list: require('./validators/project_activity_list'),
    project_activity_create: require('./validators/project_activity_create'),
    project_activity_edit: require('./validators/project_activity_edit'),
  },
  role: require('./role'),
  auth: require('./auth'),
